...
class CycleGAN():
    ...
    def compile_models(self):
        ...
        # Discriminator 의 instance 가 생성 d_a에 할당

        self.d_B = self.build_discriminator()
        # Discriminator 의 instance 가 생성 d_b에 할당
        # Img_B, Fake_B
        ...
        #gan모델의 기초로 학습되는것은 discriminator가 아님
        ...
        # 입력값이 여러개이기 떄문에 각각의 가중치에 적용시켜주어야할 loss function이 여러개이다       
    ...
    def build_discriminator(self):
        ...
        output = Conv2D(1, activation='sigmoid', kernel_size=4, strides=1, padding='same',kernel_initializer = self.weight_init)(y)
